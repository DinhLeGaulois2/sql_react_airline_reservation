...
> 1 - Create a database name '**airline_reservation**' (enter the password of **YOUR** database. Instruction in this file [here](https://github.com/DinhLeGaulois2/sql_react_airline_reservation/blob/master/server/models/index.js)).<br/>
...
At the project's root folder ([here](https://github.com/DinhLeGaulois2/sql_react_airline_reservation/blob/master/server.js)), we have a file name "**server.js**", by the end, we have:
